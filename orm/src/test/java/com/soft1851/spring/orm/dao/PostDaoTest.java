...
public class PostDaoTest {
    ...
    public void batchInsertPost() {
        Post[] posts = {Post.builder().forumId(1).title("Java1").content("学习1").build(),
                Post.builder().forumId(1).title("Java2").content("学习2").build(),
                Post.builder().forumId(1).title("Java3").content("学习3").build(),
        } ;
